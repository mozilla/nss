(mozilla-projects-nss-nss-3-94-release-notes)=
...
## [Changes in NSS 3.94](#changes_in_nss_3.94)

:::{container}

- Bug 1853737 - Updated code and commit ID for HACL\*.
- Bug 1840510 - update ACVP fuzzed test vector: refuzzed with current NSS
- Bug 1827303 - Softoken C\_ calls should use system FIPS setting to select NSC\_ or FC\_ variants.
