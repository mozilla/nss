(mozilla-projects-nss-nss-tech-notes-nss-tech-note7)=
...
- Public keys may be imported into NSS. Call
  ...
  s. Here is the ASN.1 type definition:
...
`PK11_`
 ...
 functions in pk11pub.h. As a general
...
`PK11_PubEncryptRaw`
 ...
 is the lowest level function. It takes a modulus size data and does a
...
<http://www.w3.org/TR/xmlenc-core/#rsa-1_5>

), PKCS1 v1.5 padding is described like this:
...
- [Poupou's Blog: Common question: How to encrypt using
  RSA](http://www.dotnet247.com/247reference/a.aspx?u=http://pages.infinit.net/ctech/20031101-0151.html)
:::
