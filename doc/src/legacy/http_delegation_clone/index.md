(mozilla-projects-nss-http-delegation-clone)=
...
found in [bug 152426](https://bugzilla.mozilla.org/show_bug.cgi?id=152426).
...
[bug 111384](https://bugzilla.mozilla.org/show_bug.cgi?id=111384), which tracks the
implementation in Mozilla client applications.
:::

## [Specifying an OCSP proxy](#instructions_for_specifying_an_ocsp_proxy)
