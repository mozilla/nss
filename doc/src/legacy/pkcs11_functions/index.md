(mozilla-projects-nss-pkcs11-functions)=
...
- [SECMOD_CloseUserDB](#secmod_closeuserdb)
- [PK11_FindCertFromNickname](#pk11_findcertfromnickname)
- [PK11_FindKeyByAnyCert](#pk11_findkeybyanycert)
- [PK11_GetSlotName](#pk11_getslotname)
- [PK11_GetTokenName](#pk11_gettokenname)
- [PK11_IsHW](#pk11_ishw)
- [PK11_IsPresent](#pk11_ispresent)
- [PK11_IsReadOnly](#pk11_isreadonly)
- [PK11_SetPasswordFunc](#pk11_setpasswordfunc)
...
*flags*
 ...
 A comma separated list of flag values, parsed case-insensitive.
