...
- The following CA certificate was **removed** after [discussion about
  it](https://groups.google.com/d/msg/mozilla.dev.security.policy/LKJO9W5dkSY/9VjSJhRfraIJ)
...
- The following intermediate CA certificate has been added as [actively
  distrusted](https://wiki.mozilla.org/CA:MaintenanceAndEnforcement#Actively_Distrusting_a_Certificate)
  because it was
  [misused](https://blog.mozilla.org/security/2015/04/02/distrusting-new-cnnic-certificates/) to
