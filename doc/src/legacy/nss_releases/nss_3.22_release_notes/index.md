...
## [New in NSS 3.22](#new_in_nss_3.22)
...
- Pseudorandom functions based on hashes other than SHA-1 are now supported with PBKDF ([bug
  554827](https://bugzilla.mozilla.org/show_bug.cgi?id=554827)).
...
- Enforce an External Policy on NSS from a config file ([bug
  1009429](https://bugzilla.mozilla.org/show_bug.cgi?id=1009429))
...
## [Bugs fixed in NSS 3.22](#bugs_fixed_in_nss_3.22)
