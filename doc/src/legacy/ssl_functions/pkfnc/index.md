(mozilla-projects-nss-ssl-functions-pkfnc)=
...
[Chapter 7
PKCS #11 Functions](#chapter_7_pkcs_11_functions)
\----------------------------------------------------
...
it by calling `` `CERT_DestroyCertificate `` \<sslcrt.html#1050532>\`\_\_.

The `PK11_FindCertFromNickname` function calls the password callback function set with
`` `PK11_SetPasswordFunc `` \<#1023128>\`\_\_ and passes it the pointer specified by the `wincx`
parameter.
...
must free it by calling `` `SECKEY_DestroyPrivateKey `` \<sslkey.html#1051017>\`\_\_.
...
- If successful, a pointer to the password. This memory must have been allocated with
  `` `PR_Malloc `` \<../../../../../nspr/reference/html/prmem2.html#21428>\`\_\_ or
  `` `PL_strdup `` \<../../../../../nspr/reference/html/plstr.html#21753>\`\_\_.
