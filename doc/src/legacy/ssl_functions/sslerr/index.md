(mozilla-projects-nss-ssl-functions-sslerr)=
...
[PR_GetError](../../../../../nspr/reference/html/prerr.html#PR_GetError). In addition to the
[error codes defined by
NSPR](https://dxr.mozilla.org/mozilla-central/source/nsprpub/pr/include/prerr.h), PR_GetError
retrieves the error codes described in this chapter.

[SSL Error Codes](#1040263)

[SEC Error Codes](#1039257)
:::
