(mozilla-projects-nss-ssl-functions-sslcrt)=
...
[Validating Certificates](#1060423)

[Manipulating Certificates](#1056436)

[Getting Certificate Information](#1056475)
...
`` `CERTCertificate `` \<ssltyp.html#1027387>\`\_\_.
...
copy. When you call `` `CERT_DestroyCertificate `` \<#1050532>\`\_\_ or
`` `SECKEY_DestroyPrivateKey `` \<sslkey.html#1051017>\`\_\_, the function decrements the reference
...
`` `CERT_GetCertNicknames `` \<#1050346>\`\_\_.
...
The function returns the `` `CERTCertDBHandle `` \<ssltyp.html#1028465>\`\_\_ for the default
...
Compares two `` `SECItem `` \<ssltyp.html#1026076>\`\_\_ objects and returns a `SECComparison`
