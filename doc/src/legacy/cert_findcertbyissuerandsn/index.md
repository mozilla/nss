(mozilla-projects-nss-cert-findcertbyissuerandsn)=
...
[CERT_DestroyCertificate](/en-US/NSS/CERT_DestroyCertificate) to decrement the reference count
...
:::{container}
Occurrences of
`` `CERT_FindCertByIssuerAndSN `` \<<http://lxr.mozilla.org/security/ident?i=CERT_FindCertByIssuerAndSN>>\`\_\_
in the current NSS source code (generated by [LXR](http://lxr.mozilla.org/security/)).
:::
