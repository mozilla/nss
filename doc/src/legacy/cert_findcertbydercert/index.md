(mozilla-projects-nss-cert-findcertbydercert)=
...
shallow copy, use [CERT_DestroyCertificate](/en-US/NSS/CERT_DestroyCertificate) to decrement
...
:::{container}
Occurrences of
`` `CERT_FindCertByDERCert `` \<<http://lxr.mozilla.org/security/ident?i=CERT_FindCertByDERCert>>\`\_\_
