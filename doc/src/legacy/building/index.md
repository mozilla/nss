(mozilla-projects-nss-building-ported)=
...
libraries, plus [zlib](https://www.zlib.net/).

For building, you also need [make](https://www.gnu.org/software/make/). Ideally, also install
[gyp](https://gyp.gsrc.io/) and [ninja](https://ninja-build.org/) and put them on your
...
install the [Windows
Prerequisites](https://firefox-source-docs.mozilla.org/setup/windows_build.html),
...
: 0
  ...
  : Do not create an [AddressSanitizer](http://clang.llvm.org/docs/AddressSanitizer.html)
