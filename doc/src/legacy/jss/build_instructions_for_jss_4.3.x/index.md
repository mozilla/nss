(mozilla-projects-nss-jss-build-instructions-for-jss-4-3-x)=
...
3. Install a Java compiler and runtime. JSS supports Java version 1.5 or later. We suggest you
   use the latest.
...
2. Setup environment variables needed for compiling Java source. The `JAVA_HOME` variable
...
Next, you should read the instructions on [using JSS](Using_JSS).
:::
