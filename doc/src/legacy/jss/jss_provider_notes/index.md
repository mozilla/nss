(mozilla-projects-nss-jss-jss-provider-notes)=
...
- JSS 3.2 implements several JCE (Java Cryptography Extension) algorithms. These algorithms have
  ...
  2. Apply for your own JCE code-signing certificate following the procedure at [How to
     Implement a Provider for the JavaTM Cryptography
