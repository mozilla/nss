...
JSS 4.3 is [tri-licensed](https://www.mozilla.org/MPL) under MPL 1.1/GPL 2.0/LGPL 2.1.
:::
...
query](http://bugzilla.mozilla.org/buglist.cgi?product=JSS&target_milestone=4.2.5&target_milestone=4.3&bug_status=RESOLVED&resolution=FIXED)

**JSS 4.3 requires**[NSS
3.12](https://www.mozilla.org/projects/security/pki/nss/nss-3.12/nss-3.12-release-notes.html)**or
higher.**
...
- support HmacSHA256, HmacSHA384, and HmacSHA512 (see
  [HMACTest.java](http://mxr.mozilla.org/mozilla/source/security/jss/org/mozilla/jss/tests/HMACTest.java))
...
- [Build Instructions for JSS 4.3](/jss_build_4.3.html)
- Javadoc [[online]](/javadoc)
  [[zipped]](ftp://ftp.mozilla.org/pub/mozilla.org/security/jss/releases/JSS_4_3_RTM/doc/JSS_4_3_RTM-doc.zip)
...
- JSS 4.3 requires [NSS
  ...
  or higher.
- JSS 4.3 requires [NSPR 4.7.1](https://www.mozilla.org/projects/nspr/release-notes/) or
  higher.
